    ...
    <section id="about" className='about' ref={reference} >
      <div className="container-fluid">
        ...
        <p className="aboutText">
          <h5 className="aboutTitle"><b>Swipe Through the Best:</b></h5>Our intuitive swiper feature allows you to effortlessly browse through our vast collection of games. Discover new favorites and revisit old ones with just a swipe.
        </p>
        <p className="aboutText">
          <h5 className="aboutTitle"><b>Filter and Search:</b></h5>Use our powerful filters and search tool to quickly locate the games that match your preferences. Sort by price, rating, discount, and more to find the perfect game for you.
        </p>
        <p className="aboutText">
